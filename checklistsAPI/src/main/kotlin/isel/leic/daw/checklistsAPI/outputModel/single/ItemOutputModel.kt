...
@Siren4JEntity(
        name = "item",
        uri = "/checklists/{checklistId}/items/{itemId}",
        links = [
                Siren4JLink(rel = ["next"], href = "/checklists/{checklistId}/items/{itemId}"),
                Siren4JLink(rel = ["previous"], href = "/checklists/{checklistId}/items/{itemId}")
        ],
        actions = [
                Siren4JAction(
                        name = "delete-item",
                        ...
                        href = "/checklists/{checklistId}/items/{itemId}",
...
data class ItemOutputModel(
        ...
        @Siren4JSubEntity(
                uri = "/checklists/{parent.checklistId}/items",
                rel = ["collection"],
                embeddedLink = true
        )
        val items: ItemCollectionOutputModel = ItemCollectionOutputModel(),
        @Siren4JSubEntity(
                uri = "/checklists/{parent.checklistId}",
                rel=["about"],
                embeddedLink = true
        )
